...
public class CurrencyConverterImpl implements CurrencyConverter {
    ...
    private static final String CURRENCY_RATES_API_URL_STARTING =
            "https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies/";
    private static final String CURRENCY_RATES_API_URL_ENDING = ".min.json";
    ...
    public CurrencyRatesDTO getCurrencyRates(String currency) {
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(CURRENCY_RATES_API_URL_STARTING + currency + CURRENCY_RATES_API_URL_ENDING))
                    .GET()
                    .build();
            HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
