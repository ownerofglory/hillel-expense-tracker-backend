...
create index if not exists t_category_user_id_idx on t_category (user_id);
...
create index if not exists t_expense_category_id_idx on t_expense (category_id);
create index if not exists t_expense_user_id_idx on t_expense (user_id);
...
create index if not exists t_report_user_id_idx on t_report (user_id);
...
create index if not exists report_category_category_id_idx on report_category (category_id);
create index if not exists report_category_report_id_idx on report_category (report_id);
...
create index if not exists t_tag_user_id_idx on t_tag (user_id);

create table if not exists t_tag_expense
(
    tag_id int not null,
...
create index if not exists t_tag_expense_expense_id_idx on t_tag_expense (expense_id);

create index if not exists t_user_email_idx on t_user (email);

-- create view if not exists without definer and without database references:
create view if not exists category_report_total as
