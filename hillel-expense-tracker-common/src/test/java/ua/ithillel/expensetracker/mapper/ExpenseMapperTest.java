...
class ExpenseMapperTest {
    ...
    void expenseToExpenseDTO() {
        Expense testExpense = new Expense(TestData.AMOUNT, TestData.DESCRIPTION, TestData.EXPENSE_CATEGORY, TestData.USER);
    ...
    void expenseDTOToExpense() {
        ExpenseDTO testExpenseDTO = new ExpenseDTO(TestData.AMOUNT, TestData.DESCRIPTION, TestData.EXPENSE_CATEGORY_DTO, TestData.USER_DTO);
